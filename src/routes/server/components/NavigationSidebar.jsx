        ...
        <div className="space-y-4 flex flex-col items-center h-full w-full py-3 bg-bg3">
            ...
            <div className="pb-3 mt-auto flex items-center flex-col gap-y-4">
                <button onClick={toggleTheme} >
                    <label className="swap swap-rotate btnThemeSwitch">
                        <svg
                            className={`${lightMode ? "swap-off" : "swap-on"} h-8 w-8 fill-current`}
                        ...
                        {/* moon icon */}
                        <svg
                            className={`${lightMode ? "swap-on" : "swap-off"} h-8 w-8 fill-current`}
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
