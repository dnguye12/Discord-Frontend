    ...
    return (
        <div className="tooltip tooltip-right" data-tip={name}>
            <button onClick={() => {navigate(`/servers/${id}`)}} className="group relative flex items-center">
                ...
                <div className={`relative group flex mx-3 h-[48px] w-[48px] rounded-[24px] shadow group-hover:rounded-[16px] transition-all overflow-hidden ${serverId === id ? "bg-primary text-white rounded-[16px]" : ""}`}>
